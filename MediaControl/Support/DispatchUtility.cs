...
namespace MediaControl.Support
{
    ...
    public static class DispatchUtility
    {
        ...
        public static object Invoke(object obj, string memberName, object[] args)
        {
            ...
            ////type.GetRuntimeMethod("methodName").Invoke(theObject, theParmsArray);
        ...
        private interface IDispatchInfo
        {
            ...
            // add reference to: c:\Windows\assembly\GAC_32\CustomMarshalers\2.0.0.0__b03f5f7f11d50a3a\
            void GetTypeInfo(int typeInfoIndex, int lcid, [MarshalAs(/*UnmanagedType.CustomMarshaler*/UnmanagedType.AsAny,
