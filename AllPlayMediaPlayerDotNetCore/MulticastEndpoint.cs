...
{
    // Ignore spelling: multicast wildcard routable
    class MulticastEndpoint
    {
        public List<IPAddress> localInterfaceList;
        public List<IPAddress> multicastJoinList;
        ...
        {
            localInterfaceList = new List<IPAddress>();
            multicastJoinList = new List<IPAddress>();
            bufferSize = 512;
            mcastSocket = null;
        }
        /// <summary>
        ...
        /// <param name="bufferLength">Length of the send/receive buffer to create</param>
